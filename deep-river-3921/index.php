...
<html xmlns:fb="http://ogp.me/ns/fb#" lang="en">
  ...
  <body>
    ...
    <section id="cards" class="clearfix">
		...
		<?php
            // foreach ($squishes as $squish) {
              // Extract the pieces of info we need from the requests above
			  //               $data = idx($squish, 'data');
			  //               $widget = idx($data, 'widget');
			  // $widget_title = idx($widget, 'title');
			  // $widget_url = idx($widget, 'url');

              // This display's the object that the user liked as a link to
              // that object's page.
          ?>
          <li>
            <a href="<?php echo he($widget_url); ?>">
             <?php echo he($widget_title); ?>
            </a>
          </li>
          <?php
            //}
